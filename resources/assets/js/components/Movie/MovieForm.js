  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.movie) {
      this.setState({
        ...
        tags: nextProps.movie.tags,
        cover: nextProps.movie.cover,
        editorState: BraftEditor.createEditorState(nextProps.movie.content_raw),
        editorMarkdown: nextProps.movie.content_markdown,
      });
    }
    ...
    const CoverUploader = (
      <div style={{width: 400, padding: '0 10px'}}>
        <Upload
          ...
          className="movie__cover-uploader"
          ...
          (
            <FormItem
              ...
              </a>
              {
                ...
                (
                  <ReactMarkdown
                    className="movie__markdown-preview"
